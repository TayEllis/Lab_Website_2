...
function loadStatsPage(){
	...
	for(rcounter=2;rcounter < table.rows.length;rcounter++){
		if (table.rows[rcounter].cells[2].innerHTML > table.rows[rcounter].cells[3].innerHTML){
			table.rows[rcounter].cells[4].innerHTML = "CU";
			document.getElementById("wins").innerHTML++;
		}else{
			table.rows[rcounter].cells[4].innerHTML = table.rows[rcounter].cells[1].innerHTML;
...
//pass_yards: 802, rushing_yards: 375, receiving_yards: 128}];
